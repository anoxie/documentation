...
Quand il s'agit de passer un String, il est possible d'utiliser indifférement l'un ou l'autre, dans les autres cas, il faut utiliser le property binding.


<!--stackedit_data:
eyJoaXN0b3J5IjpbMjQ0MTk0NTAwLC0xMTE0NjY1ODczLC0xMT
