...
#### Attribute binding
Il s'agit du seul cas ou un élément lié modifie un attribut ou lieu de modifier une propriété. Cette possibilité existe pour les cas ou il n'est pas possible de paramètrer une propriété, parce qu'elle n'existe pas. Par e


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwNzQxNzAwOCwtMTExNDY2NTg3MywtMT
