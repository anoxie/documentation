...
```
Le style binding est utile pour affecter un paramètre de style. mais la directive NgStyle permet d'en affecter plusieurs et lui est généralement préférable. Il est possible d'écrire les propriétés de style en dash 

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE2OTA4MTc2LC00MTEzMTA2NjgsLTcwNj
QzNzg2LC0xMTE0NjY1ODczLC0xMTg4NzMwNDQ0LDEzOTcyNjE4
ODMsMTkxMTE3ODc0OSwtMTE5MTU4NzgzOSw1OTg0OTgwNTEsLT
gwODc4MzcxNywtMjEwMDU0NjcxXX0=
-->