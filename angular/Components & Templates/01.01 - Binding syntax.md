...
Par exemple la création du template d'un component va créer une nouvelle balise HTML, qu'il sera possible d'appe


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjEwMDk3NTksLTIxMDA1NDY3MV19
-->