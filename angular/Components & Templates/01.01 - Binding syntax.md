...
|Event|Element event Component event Dirctive event|```<button (click)="onSave()">Save</button> <app-hero-detail (deleteRequest)="deleteHero()"<>/app-hero-detail>```


<!--stackedit_data:
eyJoaXN0b3J5IjpbNjg5OTg3ODcyLC04MDg3ODM3MTcsLTIxMD
A1NDY3MV19
-->