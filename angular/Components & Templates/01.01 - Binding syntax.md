...
```
### One-way ==in==
La donnée va dans un seul sens ici du component vers le template, ty
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNDg1NjAwODgsLTExOTE1ODc4MzksNT
k4NDk4MDUxLC04MDg3ODM3MTcsLTIxMDA1NDY3MV19
-->