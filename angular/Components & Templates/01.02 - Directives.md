...
Le mot clef let renvoit au stockage temporaire de l'objet hero dans la boucle, à chaque itération, c'est un nouveau h

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4NDMxMDg1MywzNDQzNzgwNjUsLTQxOD
