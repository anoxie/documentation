...
### ngSwitch
Fonctionne de la même manière qu'un switch traditionnel et est composé de 3 directives qui s'articulent ensemble ngSwitch, *ngSwitchCase, *ngSwitchDefault pas d'astérisk pour ngSwitch, puisqu'il s'agit d'une directive d'attribut, elle affectera * exemple :
```html
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyNTY4ODU0NiwxOTgwMTIwMjQ1LDExNj
kzNTQ1MDYsMjEzNjYxNDk2OSwzNDQzNzgwNjUsLTQxODA2Njc4
NSwtNjM2Mzg2NjY1XX0=
-->